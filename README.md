...
**Кубернетес кластер** - это набор машин, состоящий обычно из 1 **мастера**, и большого количества **воркеров**.
Мастер-машина определяет, на каких воркерах должно работать наше приложение, а воркеры - это уже непосредственно те
машины, на которых запускается приложение.
