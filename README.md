...
Опять пробуем открыть адреса:
- По адресу http://localhost:8888/cats-api/api/v1/cat теперь видим список всех котиков.  
...
- **Для проверки делаем запросы на эти адреса с помощью Postman**.
